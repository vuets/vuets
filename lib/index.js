...
export var vueVersion = Vue['version'] || Vue['default']['version'], vue2 = vueVersion.charAt(0) === '2';
var extend = Vue['extend'] || Vue['default']['extend'];
...
export function component(opts, clazz, fnActivate, fnDeactivate) {
    ...
    return function (cls) { return extend(fillOpts(opts || {}, cls)); };
}
